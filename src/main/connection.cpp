...
void Connection::EnableExplicitJoinOrder(string jo_json) {
	context->enable_join_order_injection = true;
	context->injected_join_order = jo_json;
}

void Connection::DisableExplicitJoinOrder() {
	context->enable_join_order_injection = false;
	context->injected_join_order.clear();
}

void Connection::EnableExplicitCardinality(string cardinality) {
	context->enable_cardinality_injection = true;
	context->injected_cardinality = cardinality;
}

void Connection::DisableExplicitCardinality() {
	context->enable_cardinality_injection = false;
	context->injected_cardinality.clear();
}
