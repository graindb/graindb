...
public:
	...
	void EnableExplicitJoinOrder(string jo_json);
	void DisableExplicitJoinOrder();

	void EnableExplicitCardinality(string cardinality);
	void DisableExplicitCardinality();
