...
WITH RECURSIVE chain as(
	SELECT m_c_replyof as parent, m_messageid as child FROM message where m_messageid = 1236950581248
	UNION ALL
...
where m_messageid = (select coalesce(min(parent), 236950581248) from chain)
