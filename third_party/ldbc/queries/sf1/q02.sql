...
with recursive cposts AS (
    select m_messageid    as m_messageid,
           m_content      as m_content,
           m_ps_imagefile as m_ps_imagefile,
           m_creationdate as m_creationdate,
           m_c_replyof    as m_c_replyof,
           m_creatorid    as m_creatorid
    from message
   ...
   , parent AS (
select m_messageid as postid, m_c_replyof as replyof, m_messageid as orig_postid, m_creatorid as creator
from cposts
UNION ALL
...
select p1.m_messageid,
       ...
       p2.p_firstname,
       p2.p_lastname
from (select m_messageid, m_content, m_ps_imagefile, m_creationdate, m_c_replyof from cposts
     ) p1
         left join
