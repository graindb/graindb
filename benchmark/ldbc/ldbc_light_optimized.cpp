...
// ic10
DUCKDB_BENCHMARK(LDBC_LIGHT_OPTIMIZED_Q016, "[ldbc_light_optimized]")
LDBC_QUERY_BODY(16, false, "ic10");
FINISH_BENCHMARK(LDBC_LIGHT_OPTIMIZED_Q016)

DUCKDB_BENCHMARK(LDBC_LIGHT_OPTIMIZED_Q016A, "[ldbc_light_optimized]")
LDBC_QUERY_BODY(16, true, "ic10");
FINISH_BENCHMARK(LDBC_LIGHT_OPTIMIZED_Q016A)
