...
DUCKDB_BENCHMARK(TPCH_OPTIMIZED_Q23, "[tpch-optimized]");
TPCH_QUERY_BODY(23, false, "EMPTY");
FINISH_BENCHMARK(TPCH_OPTIMIZED_Q23);

DUCKDB_BENCHMARK(TPCH_OPTIMIZED_Q23A, "[tpch-optimized]");
TPCH_QUERY_BODY(23, true, "EMPTY");
FINISH_BENCHMARK(TPCH_OPTIMIZED_Q23A);

DUCKDB_BENCHMARK(TPCH_OPTIMIZED_Q24, "[tpch-optimized]");
TPCH_QUERY_BODY(24, false, "EMPTY");
FINISH_BENCHMARK(TPCH_OPTIMIZED_Q24);

DUCKDB_BENCHMARK(TPCH_OPTIMIZED_Q24A, "[tpch-optimized]");
TPCH_QUERY_BODY(24, true, "EMPTY");
FINISH_BENCHMARK(TPCH_OPTIMIZED_Q24A);

DUCKDB_BENCHMARK(TPCH_OPTIMIZED_Q25, "[tpch-optimized]");
TPCH_QUERY_BODY(25, false, "EMPTY");
FINISH_BENCHMARK(TPCH_OPTIMIZED_Q25);

DUCKDB_BENCHMARK(TPCH_OPTIMIZED_Q25A, "[tpch-optimized]");
TPCH_QUERY_BODY(25, true, "EMPTY");
FINISH_BENCHMARK(TPCH_OPTIMIZED_Q25A);

DUCKDB_BENCHMARK(TPCH_OPTIMIZED_Q26, "[tpch-optimized]");
TPCH_QUERY_BODY(26, false, "EMPTY");
FINISH_BENCHMARK(TPCH_OPTIMIZED_Q26);

DUCKDB_BENCHMARK(TPCH_OPTIMIZED_Q26A, "[tpch-optimized]");
TPCH_QUERY_BODY(26, true, "EMPTY");
FINISH_BENCHMARK(TPCH_OPTIMIZED_Q26A);

DUCKDB_BENCHMARK(TPCH_OPTIMIZED_Q27, "[tpch-optimized]");
TPCH_QUERY_BODY(27, false, "EMPTY");
FINISH_BENCHMARK(TPCH_OPTIMIZED_Q27);

DUCKDB_BENCHMARK(TPCH_OPTIMIZED_Q27A, "[tpch-optimized]");
TPCH_QUERY_BODY(27, true, "EMPTY");
FINISH_BENCHMARK(TPCH_OPTIMIZED_Q27A);

DUCKDB_BENCHMARK(TPCH_OPTIMIZED_Q28, "[tpch-optimized]");
TPCH_QUERY_BODY(28, false, "EMPTY");
FINISH_BENCHMARK(TPCH_OPTIMIZED_Q28);

DUCKDB_BENCHMARK(TPCH_OPTIMIZED_Q28A, "[tpch-optimized]");
TPCH_QUERY_BODY(28, true, "EMPTY");
FINISH_BENCHMARK(TPCH_OPTIMIZED_Q28A);

DUCKDB_BENCHMARK(TPCH_OPTIMIZED_Q29, "[tpch-optimized]");
TPCH_QUERY_BODY(29, false, "EMPTY");
FINISH_BENCHMARK(TPCH_OPTIMIZED_Q29);

DUCKDB_BENCHMARK(TPCH_OPTIMIZED_Q29A, "[tpch-optimized]");
TPCH_QUERY_BODY(29, true, "EMPTY");
FINISH_BENCHMARK(TPCH_OPTIMIZED_Q29A);

DUCKDB_BENCHMARK(TPCH_OPTIMIZED_Q30, "[tpch-optimized]");
TPCH_QUERY_BODY(30, false, "EMPTY");
FINISH_BENCHMARK(TPCH_OPTIMIZED_Q30);

DUCKDB_BENCHMARK(TPCH_OPTIMIZED_Q30A, "[tpch-optimized]");
TPCH_QUERY_BODY(30, true, "EMPTY");
FINISH_BENCHMARK(TPCH_OPTIMIZED_Q30A);

DUCKDB_BENCHMARK(TPCH_OPTIMIZED_Q31, "[tpch-optimized]");
TPCH_QUERY_BODY(31, false, "EMPTY");
FINISH_BENCHMARK(TPCH_OPTIMIZED_Q31);

DUCKDB_BENCHMARK(TPCH_OPTIMIZED_Q31A, "[tpch-optimized]");
TPCH_QUERY_BODY(31, true, "EMPTY");
FINISH_BENCHMARK(TPCH_OPTIMIZED_Q31A);

DUCKDB_BENCHMARK(TPCH_OPTIMIZED_Q32, "[tpch-optimized]");
TPCH_QUERY_BODY(32, false, "EMPTY");
FINISH_BENCHMARK(TPCH_OPTIMIZED_Q32);

DUCKDB_BENCHMARK(TPCH_OPTIMIZED_Q32A, "[tpch-optimized]");
TPCH_QUERY_BODY(32, true, "EMPTY");
FINISH_BENCHMARK(TPCH_OPTIMIZED_Q32A);
